...
record RegisterForm(
    ...
    RegisterForm {
        ...
        assertRegularExpression(tel, TEL.getRegex(), "전화번호 형식이 유효하지 않습니다. (예: 010-1234-5678)");
        assertRegularExpression(password, PASSWORD.getRegex(8, 20), "비밀번호는 8~20자의 영문자, 숫자, 특수문자를 포함해야 합니다.");
