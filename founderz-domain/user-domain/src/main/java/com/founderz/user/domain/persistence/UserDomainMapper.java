...
interface UserDomainMapper {
    ...
    @Mapping(target = "myMoney", expression = "java(dto.myMoney().money())")
    ...
    @Mapping(target = "userId", expression = "java(UserId.create(entity.getId()))")
    ...
    @Mapping(target = "myMoney", expression = "java(MyMoney.create(entity.getMyMoney()))")
